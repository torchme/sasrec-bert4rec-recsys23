...
def train_model(config):
    ...
    # read finetune_train_sequences - this is the main dataset
    ...
    config['model']['user_num'] = num_users + len(profile_train_sequences)

    for user_id, sequence in (finetune_train_sequences.items()):
        profile_train_sequences[user_id+num_users] = sequence
